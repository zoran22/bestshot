            ...
            <table id="table" class="table table-striped table-responsive no-more-tables" >
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="javascript:banComment('<?= $comment->getComment(); ?>', '<?= $comment->getComment_id(); ?>')" class="btn btn-primary btn-circle"><span class="fa fa-check"></span></a></td>
...
<script>
    ...
    function banComment(comment, idComment) {
        if (confirm("Are you sure you want to ban this comment: '" + comment + "' ?")) {

            window.location.href = '<?= DIRADMINPANEL; ?>allComments.php?b=' + idComment;
