...
<html lang="en">
    ...
    <head>
        ...
        <!-- Template styles -->
        <link href="<?= DIR; ?>public/css/style.cs" rel="stylesheet" type="text/css"/>
        <style>
            html,
            body,
            header,
                                ...
                                <form action="" method="post">
                                    <div class="card wow fadeInRight">
                                        <div class="card-block">
                                            ...
                                            <div class="text-center">
                                                <button type="submit" name="submit"  value="Login" class="btn btn-success btn-group-sm">Login</button>
